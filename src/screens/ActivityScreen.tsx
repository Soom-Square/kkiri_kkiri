              ...
              <View style={styles.progressTitleRow}>
                ...
                >
                  <Image
                    ...
                    style={[
                      styles.foldIcon,
                      !graphOpen && { transform: [{ rotate: '180deg' }] }, // 상하 반전
                    ]}
                    resizeMode="contain"
                  />
                </Pressable>
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#FFFFFF', paddingTop: 24, paddingHorizontal: 20 },
  scrollBody: { paddingBottom: 140, backgroundColor: '#FFFFFF' },

  topRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  brand: { fontSize: 28, fontWeight: '800', color: PURPLE },
  ...
  dropdownList: { position: 'absolute', top: '100%', left: 0, right: 0, backgroundColor: '#fff', borderRadius: 12, overflow: 'hidden', borderWidth: StyleSheet.hairlineWidth, borderColor: '#E5E7EB', maxHeight: 220, zIndex: 9999, elevation: 5 },
